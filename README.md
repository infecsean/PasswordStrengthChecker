...
The program will prompt you to enter a password, please do not enter any password you actually want to use, details [[#Limitations & Considerations|below]]. After you enter the password, the program will return a report containing potential issues with the password including character diversity, exact match or partial match with common password patterns, and a summarizing score on a scale of 1-10, indicating how strong the input password is.
